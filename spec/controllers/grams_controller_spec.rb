...
RSpec.describe GramsController, type: :controller do
  ...
  describe "grams#destroy action" do
    it "should'nt let users who did not create the gram destroy the gram" do
  ...
  describe "grams#update action" do
    it "shouldn't let users who did not create the gram to update it" do
      gram = FactoryGirl.create(:gram)
      user = FactoryGirl.create(:user)
      sign_in user
  ...
  describe "grams#show action" do
    it "should successfully show the page if hte gram is found" do
      gram = FactoryGirl.create(:gram)
      get :show, id: gram.id
      expect(response).to have_http_status(:success)
    end
  ...
  describe "grams#new action" do
    ...
    it "should successfully show the form for a new gram" do
      user = FactoryGirl.create(:user)
      sign_in user
